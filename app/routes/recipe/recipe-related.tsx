...
import { FiClock, FiThermometer, FiTool, FiPackage, FiInfo, FiFilm, FiList, FiShoppingBag, FiUsers } from "react-icons/fi";
import { Recipe, RecipeIngredient, RecipeInstruction } from "~/core/type";
...
export const RecipeDetail = memo(function DishDetail({ recipe }: { recipe: Recipe }) {
  return (
