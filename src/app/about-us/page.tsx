    ...
    <MenuLayout>
      <div className="relative max-w-4xl mx-auto p-8 space-y-12">
        ...
        <div className="text-center space-y-6">
          <h1 className="font-serif text-4xl md:text-5xl font-medium text-slate-800 dark:text-slate-200">
            Revolutionizing Meal Planning
          </h1>
          <p className="text-lg max-w-2xl mx-auto text-slate-600 dark:text-slate-400">
            Never wonder &quot;what&apos;s for dinner&quot; again. Our AI-powered platform creates personalized recipes
            based on your preferences, pantry items, and cooking skill level.
          </p>
        </div>
